...
// ! Ekle iconun tıklayınca popup açılsın
...
closeIcon.addEventListener("click", () => {
  ...
  // Güncelleme modunu kapatıp varsayılan "Not Ekle" moduna döndük
  isUpdate = false;
  popupTitle.textContent = "Add Note";
  button.textContent = "Add Note";

  // Input ve textarea'nın içeriğini temizledik
...
// ! Not Silme özelliğini sağlayan fonksiyon
...
// ! Not Güncellemesi özelliğini sağlayan fonksiyon
...
function showMenu(elem) {
  // Kapsam elemanına show class ı ekledik
  elem.parentElement.classList.add("show");
  // Menu harici bir yere tıklanırsa show class ını kaldır
  document.addEventListener("click", (e) => {
    // Tıklanılan elemana i etiketi değilse yada kapsam elemana eşit değilse show classını kaldır.
...
wrapper.addEventListener("click", (e) => {
  // Eğer menu üç nokta iconuna tıklanırsa showMenu fonk. çalışır.
  if (e.target.classList.contains("bx-dots-horizontal-rounded")) {
    showMenu(e.target);
  }
  // Eğer sil iconuna tıklandıysa deleteNote fonk. çalışır
